...
setup_kitty_local_conf() {
  section "[macOS] Write kitty local.conf"
  local conf="$HOME/.config/kitty/local.conf"
  mkdir -p "$(dirname "$conf")"
  cat > "$conf" <<'EOF'
# Machine-local Kitty overrides (macOS)
# Auto-generated by macos-install.sh -- edit freely
...
setup_directories() {
    section "[macOS] User directories"
